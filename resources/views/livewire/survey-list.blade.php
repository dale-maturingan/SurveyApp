                ...
                @if ($survey_posted["active"] > 0)
                    ...
                    <div class="card_notification">
                        <div class="notification">
                            ...
                            <div class="notititle">Survey #{{ $survey_posted->id }}: {{ $survey_posted->surveyTitle }}</div>
                            <hr class="solid" style="border-top: 3px solid #9f9d9d">
                            <div class="notibody">{{ $survey_posted->surveyDesc }}</div>
                            <a class="start_survey" href="{{ route('answer_survey', ['survey_selected' => $survey_posted->id]) }}">START</a>
                        </div>
                    </div>
                @endif
            @endforeach
                    ...
                    <table>
                        <tbody>
                            <div class="notititle">
                                <tr>
                                    <th colspan="7">
                                        <a class = "message" href="{{ url('new_survey') }}"><button class = "survey_action new_survey"><img
                                                    src="{{ URL::asset('/images/icon-plus.svg') }}"> New Survey</button></a>
                                    </th>
                                </tr>
                                <tr>
                                    <th>#</th>
